...
const WELCOME_POPUP_CONTENT: { [category in WorkspaceCategories]?: WelcomeContent } = {
  [WorkspaceCategories.MarineManager]: {
    ...
    es: {
      ...
      <h2> <img src = "https://globalfishingwatch.org/website3/wp-content/uploads/icon-line-caught-fish-orange.png"> Esfuerzo de pesca aparente </h2>
      ...
      <h2> <img src = "https://globalfishingwatch.org/website3/wp-content/uploads/icon-vessel-orange.png"> Actividad de la embarcación </h2>
      ...
      <h2> <img src = "https://globalfishingwatch.org/website3/wp-content/uploads/icon-email-orange.png"> Comentarios </h2>
      ...
      <h2> <img src = "https://globalfishingwatch.org/website3/wp-content/uploads/icon-graph-orange-1.png"> Regístrese para obtener acceso gratuito a todas las funciones </h2>
