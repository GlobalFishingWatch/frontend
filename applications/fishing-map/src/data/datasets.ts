...
export const DEFAULT_BASEMAP_DATAVIEW_ID = ENV === 'development' ? 90 : 173
export const DEFAULT_VESSEL_DATAVIEW_ID = ENV === 'development' ? 92 : 171
export const DEFAULT_FISHING_DATAVIEW_ID = ENV === 'development' ? 91 : 178
