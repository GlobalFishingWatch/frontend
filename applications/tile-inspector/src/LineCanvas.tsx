...
const LineCanvas = ({ data, width, height, domainX, domainY, onClick }: { data: Cell[], width: number, height:number, domainX: number[], domainY: number[], onClick: any }) => {
  ...
  useEffect(() => {
      ...
      const factory = quadtree(points as any, d => (d as any).x, d => (d as any).y)
