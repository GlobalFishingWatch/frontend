...
const ActivityFilters: React.FC = (): React.ReactElement => {
  ...
  return (
    <Fragment>
      ...
      <Modal
        isOpen={showFiltersInfo}
        onClose={() => setShowFiltersInfo(false)}
      ...
      >
        ...
        <p>
          <span className={styles.eventsLabel}>
            {t('events.fishingEvents', 'Fishing Events')}:{' '}
          </span>
          <Trans i18nKey="events.fishingEventsDescription">
            ...
            our research has identified as known or possible commercial fishing vessels, and apply a
        ...
        <p>
          ...
          <Trans i18nKey="events.encounterEventsDescription">
            ...
            traveling at a median speed &lt;2 knots, while at least 10 km from a coastal anchorage.
          </Trans>
        </p>
        <p>
          <span className={styles.eventsLabel}>
          ...
          <Trans i18nKey="events.loiteringEventsDescription">
            ...
            possible for a loitering event to overlap with encounter events and to encompass one or
            more encounter events.
          </Trans>
        </p>
        <p>
