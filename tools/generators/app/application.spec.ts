...
describe('app', () => {
  ...
  describe('--style scss', () => {
    it('should generate scss styles', async () => {
      ...
      expect(indexContent).toContain(`import styles from './index.module.scss'`)
    })
  })
  ...
  describe('--style less', () => {
    it('should generate scss styles', async () => {
      ...
      const indexContent = tree.read('apps/my-app/pages/index.tsx', 'utf-8')
      expect(indexContent).toContain(`import styles from './index.module.less'`)
    })
  })
  ...
  describe('--style styl', () => {
    it('should generate scss styles', async () => {
      ...
      const indexContent = tree.read('apps/my-app/pages/index.tsx', 'utf-8')
      expect(indexContent).toContain(`import styles from './index.module.styl'`)
    })
  })
  ...
  describe('--style styled-components', () => {
    it('should generate scss styles', async () => {
      ...
      expect(tree.exists('apps/my-app/pages/index.module.styled-components')).toBeFalsy()
      expect(tree.exists('apps/my-app/pages/styles.css')).toBeTruthy()
  ...
  describe('--style @emotion/styled', () => {
    ...
    it('should add jsxImportSource in tsconfig.json', async () => {
      ...
      expect(tsconfigJson.compilerOptions['jsxImportSource']).toEqual('@emotion/react')
    })
  })
  ...
  describe('--style styled-jsx', () => {
    it('should use <style jsx> in index page', async () => {
      ...
      expect(tree.exists('apps/my-app/pages/index.module.styled-jsx')).toBeFalsy()
      expect(tree.exists('apps/my-app/pages/styles.css')).toBeTruthy()

      expect(indexContent).not.toContain(`import styles from './index.module`)
      expect(indexContent).not.toContain(`import styled from 'styled-components'`)
    })
  })
