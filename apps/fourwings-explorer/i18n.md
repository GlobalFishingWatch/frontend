...
i18n is configured [here](applications/fourwings-explorer/src/features/i18n/i18n.ts) following this [spec](https://www.i18next.com/overview/configuration-options).
...
The source file, and its translations are located at the [locales folder](applications/fourwings-explorer/public/locales, served by HTTP and managed by [backend-plugin](https://github.com/i18next/i18next-http-backend).
...
[i18n-parser](https://github.com/i18next/i18next-parser) script syncs the code and the translations extracting the keys to the `source/translations.json` file. It's configured [here](applications/fourwings-explorer/i18next-parser.config.js). Tu execute it, run:
...
- [`I18nFlag`](applications/fourwings-explorer/src/features/i18n/i18nFlag.tsx)
- [`I18nDate`](applications/fourwings-explorer/src/features/i18n/i18nDate.tsx) using [luxon formatting](https://moment.github.io/luxon/docs/class/src/datetime.js~DateTime.html)
- [`I18nNumber`](applications/fourwings-explorer/src/features/i18n/i18nNumber.tsx)
