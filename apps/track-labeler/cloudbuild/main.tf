...
module "develop" {
  ...
  set_secrets = [
    "BASIC_AUTH_PASS=${local.secrets_path.dev}/BASIC_AUTH_PASS_TRACK_LABELER",
  ]
}
...
module "staging" {
  ...
  set_secrets = [
    "BASIC_AUTH_PASS=${local.secrets_path.sta}/BASIC_AUTH_PASS_TRACK_LABELER",
  ]
}
