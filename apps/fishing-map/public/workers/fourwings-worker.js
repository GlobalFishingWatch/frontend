...
(() => {
  ...
  var FourwingsLoader = {
    ...
    parse: async (arrayBuffer, options = {}) => parseFourwings(arrayBuffer, options),
    parseSync: async (arrayBuffer, options = {}) => parseFourwings(arrayBuffer, options),
    binary: true
  };
  ...
  // src/workers/fourwings-worker.ts
