const TURNING_TIDES_BRAZIL_ID = process.env.VITE_TURNING_TIDES_BRAZIL_ID || ''
const TURNING_TIDES_CHILE_ID = process.env.VITE_TURNING_TIDES_CHILE_ID || ''
const TURNING_TIDES_PERU_ID = process.env.VITE_TURNING_TIDES_PERU_ID || ''
const TURNING_TIDES_AIS_ID = process.env.VITE_TURNING_TIDES_AIS_ID || ''
