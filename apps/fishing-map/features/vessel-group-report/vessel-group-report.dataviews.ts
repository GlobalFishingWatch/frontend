...
type VesselGroupEventsDataviewId = `${typeof VESSEL_GROUP_DATAVIEW_PREFIX}${VGREventsSubsection}`
...
> = {
  ...
  loitering: VESSEL_GROUP_ENCOUNTER_EVENTS_ID,
  gaps: VESSEL_GROUP_ENCOUNTER_EVENTS_ID,
  port_visits: VESSEL_GROUP_ENCOUNTER_EVENTS_ID,
}
