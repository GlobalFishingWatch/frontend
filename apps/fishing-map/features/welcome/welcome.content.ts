...
export type WelcomeContentKey = WorkspaceCategory | 'vessel-profile' | 'deep-sea-mining'
  ...
  'deep-sea-mining': {
    ...
    en: {
      ...
      description: `
        ...
        <p>This report summarizes the activity of vessels known to historically or actively engage in deep-sea mineral activities in regions containing International Seabed Authority (ISA) license areas, including the Eastern and Western Pacific, Atlantic and Indian Oceans. As commercial mining has not yet begun, <a href="https://globalfishingwatch.org/map/report/deep_sea_mining-public?longitude=2.4565&latitude=-3.86920823&zoom=0.89021091&start=2024-12-24T00%3A00%3A00.000Z&end=2025-03-24T00%3A00%3A00.000Z&dvIn[0][id]=presence&dvIn[0][cfg][filters][speed][0]=4-6&dvIn[0][cfg][filters][speed][1]=%3C2&dvIn[0][cfg][filters][speed][2]=2-4&dvIn[0][cfg][filters][vGs][0]=deep_sea_mining_vessels-public" rel="noopener noreferrer" target="_blank">this report</a> and these data in Deep-Sea Mining Watch depict only exploration activity. </p>
