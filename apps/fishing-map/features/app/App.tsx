...
import { useMapFitBounds, useSetViewstate } from 'features/map/map-viewport.hooks'
  ...
  useLayoutEffect(() => {
    if (isReportLocation) {
      if (reportAreaBounds) {
        ...
        setViewState((vs) => ({ ...vs, latitude: 0, longitude: 0, zoom: 0 }))
      }
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [])
