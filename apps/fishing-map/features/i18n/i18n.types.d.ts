interface Resources {
  ...
  translations: {
    ...
    download: {
      ...
      trackRemaining: 'download.trackRemaining'
      yearly: 'Year'
    ...
    event: {
      ...
      during: 'during'
      encounter: 'Encounter' | 'Encounter events'
      ...
      loitering: 'Loitering' | 'Loitering events'
      ...
      port_visit: 'Port visit' | 'Port visits'
    ...
    layer: {
      ...
      flagState: 'layer.flagState' | 'Flag' | 'Flags'
      fleet: 'Fleets'
      gearType: 'Gear types'
      genus: 'Genus'
      ...
      height: 'Height'
      name: 'Layer name'
      nameLengthError: 'layer.nameLengthError'
    ...
    search: {
      ...
      minCharacters: 'search.minCharacters'
    ...
    vessel: {
      ...
      vesselType: 'Vessel type' | 'Vessel types'
      vesselTypes: {
        bunker: 'Bunker'
        bunker_or_tanker: 'Bunker or tanker'
        cargo: 'Cargo'
      ...
      voyage: 'vessel.voyage' | 'voyage' | 'voyages'
    ...
    vesselGroup: {
      ...
      tooManyVessels: 'vesselGroup.tooManyVessels'
    ...
    vesselGroupReport: {
      ...
      insights: {
        IUUBlackListsCount:
          | '{{vessels}} vessels are present on a RFMO IUU vessel list'
          | '{{vessels}} vessel is present on a RFMO IUU vessel list'
          | '{{vessels}} vessels are present on a RFMO IUU vessel list'
        IUUBlackListsEmpty: 'No vessels are present on a RFMO IUU vessel list'
        MOULists: 'MOU Lists'
        MOUListsCount:
          | '{{vessels}} vessels operated under a flag present on the {{list}} list'
          | '{{vessels}} vessel operated under a flag present on the {{list}} list'
          | '{{vessels}} vessels operated under a flag present on the {{list}} list'
        ...
        fishingInNoTakeMpas:
          | '{{count}} fishing event from {{vessels}} vessels detected in no-take MPAs'
          | '{{count}} fishing events from {{vessels}} vessels detected in no-take MPAs'
        fishingInRfmoWithoutKnownAuthorization:
          | '{{count}} fishing event from {{vessels}} vessels detected outside known RFMO authorized areas'
          | '{{count}} fishing event from {{vessels}} vessels detected outside known RFMO authorized areas'
        flagChangesCount:
          | '{{vessels}} vessels had flag changes'
          | '{{vessels}} vessel had flag changes'
          | '{{vessels}} vessels had flag changes'
    ...
    vesselGroups: {
      insights: {
        fishingInNoTakeMpas: 'vesselGroups.insights.fishingInNoTakeMpas'
        fishingInRfmoWithoutKnownAuthorization: 'vesselGroups.insights.fishingInRfmoWithoutKnownAuthorization'
        gaps: 'vesselGroups.insights.gaps'
      }
    }
    workspace: {
