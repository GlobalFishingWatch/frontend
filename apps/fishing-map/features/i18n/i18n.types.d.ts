interface Resources {
  ...
  "translations": {
    ...
    "download": {
      ...
      "trackRemaining": "You can download {{count}} more track today" | "" | "You can download {{count}} more tracks today",
      "yearly": "Year",
    ...
    "layer": {
      ...
      "height": "Height",
      "name": "Layer name",
      "nameLengthError": "Layer name requires at least {{count}} characters" | "" | "Layer name requires at least {{count}} characters",
    ...
    "search": {
      ...
      "minCharacters": "Please type at least {{count}} character" | "" | "Please type at least {{count}} characters",
    ...
    "vessel": {
      ...
      "insights": {
        ...
        "fishingEventsInNoTakeMpas": "{{count}} fishing events detected in no-take MPAs" | "" | "{{count}} fishing events detected in no-take MPAs",
    ...
    "vesselGroup": {
      ...
      "tooManyVessels": "Maximum number of vessels is {{count}}" | "" | "Maximum number of vessels is {{count}}",
    ...
    "vesselGroups": {
      "insights": {
        "fishingInNoTakeMpas": "{{count}} fishing events from {{vessels}} vessels detected in no-take MPAs" | "" | "{{count}} fishing events from {{vessels}} vessels detected in no-take MPAs",
        "fishingInRfmoWithoutKnownAuthorization": "{{count}} fishing events from {{vessels}} vessels detected outside known RFMO authorized areas" | "" | "{{count}} fishing events from {{vessels}} vessels detected outside known RFMO authorized areas",
        "gaps": "{{count}} AIS Off Event from {{vessels}} vessels detected" | "" | "{{count}} AIS Off Event from {{vessels}} vessels detected"
      }
    },
    "workspace": {
