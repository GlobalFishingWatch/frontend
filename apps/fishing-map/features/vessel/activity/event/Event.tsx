...
const ActivityEvent: React.FC<EventProps> = (props): React.ReactElement => {
  ...
  return (
    <li className={cx(styles.event, classname)} style={style}>
      <div className={cx(styles.eventIcon, styles[event.type], styles[getEncounterStatus(event)])}>
      ...
      <div className={styles.actions}>
        ...
        <IconButton icon="view-on-map" size="small" onClick={() => onMapClick(event)}></IconButton>
      </div>
    </li>
  )
}
