...
export const DEFAULT_VESSEL_IDENTITY_DATASET = 'public-global-vessel-identity-vi-653'
export const DEFAULT_VESSEL_IDENTITY_ID = `${DEFAULT_VESSEL_IDENTITY_DATASET}:v1.0` as const
