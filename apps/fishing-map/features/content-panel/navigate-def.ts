// Shared isomorphic navigate tool definition. Server (gfw-agent) passes this
// (no execute) into chat(); the React client binds .client() to TanStack Router.
// Keep in sync with gfw-agent/src/ai/tools/navigate-def.ts.
