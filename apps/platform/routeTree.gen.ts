...
import { Route as PlatformContentRouteImport } from './routes/_platform/_content'
import { Route as PlatformMapRouteImport } from './routes/_platform/_map'
...
import { Route as PlatformContentUserRouteImport } from './routes/_platform/_content/user'
import { Route as PlatformContentVesselSearchRouteImport } from './routes/_platform/_content/vessel-search'
import { Route as PlatformMapMapRouteImport } from './routes/_platform/_map/map'
...
import { Route as PlatformMapMapIndexRouteImport } from './routes/_platform/_map/map/index'
import { Route as PlatformMapReportReportIdRouteImport } from './routes/_platform/_map/report.$reportId'
import { Route as PlatformMapVesselVesselIdRouteImport } from './routes/_platform/_map/vessel.$vesselId'
...
import { Route as PlatformMapMapCategoryIndexRouteImport } from './routes/_platform/_map/map/$category/index'
import { Route as PlatformMapMapCategoryWorkspaceIdRouteImport } from './routes/_platform/_map/map/$category/$workspaceId'
import { Route as PlatformMapMapCategoryWorkspaceIdIndexRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/index'
import { Route as PlatformMapMapCategoryWorkspaceIdVesselSearchRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/vessel-search'
import { Route as PlatformMapMapCategoryWorkspaceIdPortsReportPortIdRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/ports-report.$portId'
import { Route as PlatformMapMapCategoryWorkspaceIdReportIndexRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/report/index'
import { Route as PlatformMapMapCategoryWorkspaceIdVesselGroupReportVesselGroupIdRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/vessel-group-report.$vesselGroupId'
import { Route as PlatformMapMapCategoryWorkspaceIdVesselVesselIdRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/vessel.$vesselId'
import { Route as PlatformMapMapCategoryWorkspaceIdReportDatasetIdAreaIdRouteImport } from './routes/_platform/_map/map/$category/$workspaceId/report/$datasetId/$areaId'
