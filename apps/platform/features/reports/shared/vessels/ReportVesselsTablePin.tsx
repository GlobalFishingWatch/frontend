...
import { getVesselDataview } from 'features/map/dataviews/dataviews.utils'
...
export default function ReportVesselsTablePinAll({ vessels, onClick }: ReportVesselTablePinProps) {
  ...
  const vesselPinnedIds = allVesselsInWorkspace.map((dI) => getVesselIdFromInstanceId(dI.id))
