...
import { hasWorkspaceDataviewsDeprecated } from 'features/map/dataviews/dataviews.utils'
import { useSetMapCoordinates } from 'features/map/map/map-viewport.hooks'
import EditWorkspace from 'features/map/workspace/save/WorkspaceEdit'
import { getWorkspaceLabel } from 'features/map/workspace/workspace.utils'
