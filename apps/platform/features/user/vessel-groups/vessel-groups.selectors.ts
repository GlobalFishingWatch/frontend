...
import { getVesselGroupsInDataviews } from 'features/map/datasets/datasets.utils'
import { selectActiveVesselGroupDataviews } from 'features/map/dataviews/selectors/dataviews.categories.selectors'
import { selectActiveActivityAndDetectionsDataviews } from 'features/map/dataviews/selectors/dataviews.selectors'
import {
...
import { FLAG_LENGTH, SSVID_LENGTH, VESSEL_ID_LENGTH } from 'features/vessels/search/search.config'
