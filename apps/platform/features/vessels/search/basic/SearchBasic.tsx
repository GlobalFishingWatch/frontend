...
import SearchBasicResultList from 'features/vessels/search/basic/SearchBasicResultList'
import { MIN_SEARCH_CHARACTERS, RESULTS_PER_PAGE } from 'features/vessels/search/search.config'
import { selectSearchQuery } from 'features/vessels/search/search.config.selectors'
import { useSearchConnect } from 'features/vessels/search/search.hook'
import { isBasicSearchAllowed, selectBasicSearchDatasets } from 'features/vessels/search/search.selectors'
import {
  selectSearchResults,
  selectSearchStatus,
...
import {
  ...
  SearchNotAllowed,
} from 'features/vessels/search/SearchPlaceholders'
