...
import { getVesselDataviewInstance } from 'features/map/dataviews/dataviews.utils'
...
import { selectCurrentWorkspaceId, selectWorkspace } from 'features/map/workspace/workspace.selectors'
...
} from 'features/user/vessel-groups/VesselGroupAddButton'
import { EMPTY_SEARCH_FILTERS } from 'features/vessels/search/search.config'
import { getRelatedIdentityVesselIds } from 'features/vessels/vessel/vessel.utils'
...
function SearchActions() {
  ...
  return (
    <Fragment>
      ...
      >
        {t((t) => t.search.seeVesselsOnMap, { count: vesselsSelected?.length ?? 0 })}
      </Button>
    </Fragment>
  )
}
