...
import { selectVesselInfoDataId } from 'features/vessels/vessel/selectors/vessel.selectors'
...
import { getVesselIdentityId } from 'features/vessels/vessel/vessel.utils'
import {
...
const VesselLink = ({
  ...
  const linkTo = standaloneLink ? ROUTE_PATHS.VESSEL : ROUTE_PATHS.WORKSPACE_VESSEL
