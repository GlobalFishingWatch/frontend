...
import { selectActiveTrackDataviews } from 'features/map/dataviews/selectors/dataviews.instances.selectors'
...
import { selectVesselSelfReportedId } from 'features/vessels/vessel/vessel.config.selectors'
