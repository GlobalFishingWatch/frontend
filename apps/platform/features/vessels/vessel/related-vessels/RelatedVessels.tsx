...
import RelatedEncounterVessels from 'features/vessels/vessel/related-vessels/RelatedEncounterVessels'
import RelatedOwnersVessels from 'features/vessels/vessel/related-vessels/RelatedOwnersVessels'
import { selectVesselRelatedSubsection } from 'features/vessels/vessel/vessel.config.selectors'
...
const RelatedVessels = () => {
  ...
  return (
    <div className={styles.container}>
      <h2 className="print-only">{t((t) => t.vessel.sectionRelatedVessel)}</h2>
