...
import { selectVesselProfileColor } from 'features/map/dataviews/selectors/dataviews.instances.selectors'
import { useMapFitBounds } from 'features/map/map/map-bounds.hooks'
import { useDebouncedDispatchHighlightedEvent } from 'features/map/map/map-interactions.hooks'
import { DATAVIEWS_WARNING } from 'features/map/workspace/context-areas/context.utils'
import { getModalParent } from 'features/modals/modals.utils'
import { useFetchRegionsData } from 'features/vessels/vessel/activity/event/event.hook'
import { VesselActivitySummary } from 'features/vessels/vessel/activity/VesselActivitySummary'
import {
  selectEventsGroupedByArea,
  selectVesselEventTypes,
  UNKNOWN_AREA,
} from 'features/vessels/vessel/activity/vessels-activity.selectors'
import { selectVesselEventsFilteredByTimerange } from 'features/vessels/vessel/selectors/vessel.resources.selectors'
import { selectVesselAreaSubsection } from 'features/vessels/vessel/vessel.config.selectors'
