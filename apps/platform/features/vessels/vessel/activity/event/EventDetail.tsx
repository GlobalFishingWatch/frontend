...
import { getHasVesselProfileInstance } from 'features/map/dataviews/dataviews.utils'
...
import { useActivityEventTranslations } from 'features/vessels/vessel/activity/event/event.hook'
import { DEFAULT_VESSEL_IDENTITY_ID } from 'features/vessels/vessel/vessel.config'
import { selectVesselDatasetId } from 'features/vessels/vessel/vessel.config.selectors'
import { useVesselProfileEncounterLayer } from 'features/vessels/vessel/vessel.hooks'
...
import VesselPin from 'features/vessels/vessel/VesselPin'
