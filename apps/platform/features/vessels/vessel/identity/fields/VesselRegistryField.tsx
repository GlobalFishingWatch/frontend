...
import { useRegionTranslationsById } from 'features/data/regions/regions.hooks'
...
import type { VesselRenderField } from 'features/vessels/vessel/identity/vessel-identity.config'
import { filterRegistryInfoByDateAndSSVID } from 'features/vessels/vessel/vessel.utils'
    ...
    return (
      <div className={cx(styles.fieldGroupContainer, styles.flex)} key={key}>
        ...
        {vesselIdentity.recordId ? (
          <VesselIdentityField value={vesselIdentity.recordId} />
        ) : (
