...
import { HOTSPOT_COLOR } from 'features/_map/map/map.config'
import {
  getDrawDatasetDefinition,
  getFileWithFeatures,
} from 'features/_map/map/overlays/draw/draw.utils'
import { selectTimeRange } from 'features/_map/workspace/selectors/app.timebar.selectors'
import { KILOMETERS, NAUTICAL_MILES } from 'features/_reports/report-area/area-reports.config'
import { selectReportArea } from 'features/_reports/report-area/area-reports.selectors'
import { selectReportActivitySubCategory } from 'features/_reports/reports.selectors'
import { hotspotGeometryAtom, useHotspotSettings } from 'features/_reports/reports-hotspot.hooks'
import { formatArea, NM2_TO_KM2 } from 'features/_reports/reports-hotspot.utils'
