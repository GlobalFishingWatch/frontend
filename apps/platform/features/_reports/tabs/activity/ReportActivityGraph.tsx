...
import { REPORT_ACTIVITY_GRAPH_DATASET_COMPARISON } from 'features/_reports/reports.config'
...
import { useComputeReportHotspot } from 'features/_reports/reports-hotspot.hooks'
...
import ReportHotspotControls from 'features/_reports/tabs/activity/ReportHotspotControls'
    ...
    <div className={styles.container}>
      {showSelectors && (
        <div className={styles.titleRow}>
          ...
          {!isEmptyData && !hasError && featureFlags[FeatureFlag.HotspotButton] && (
      ...
      {!isInitialLoad && (
        <Fragment>
          <div className={styles.disclaimer}>
            <UserGuideLink slug="analysis-and-dynamic-reports" />
