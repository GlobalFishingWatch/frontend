...
import { selectDataviewInstancesByCategory } from 'features/_map/dataviews/selectors/dataviews.categories.selectors'
import {
  useLayerFilterHandlers,
  useLayerFilterState,
} from 'features/_map/workspace/shared/LayerFilters.hooks'
import LayerFiltersGap from 'features/_map/workspace/shared/LayerFiltersGap'
import LayerFiltersSource from 'features/_map/workspace/shared/LayerFiltersSource'
import LayerSchemaFilter from 'features/_map/workspace/shared/LayerSchemaFilter'
...
const HistogramRangeFilter = lazy(
  () => import('features/_map/workspace/environmental/HistogramRangeFilter')
)
