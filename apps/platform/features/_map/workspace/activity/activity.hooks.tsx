...
import { PREFERRED_FOURWINGS_VISUALISATION_MODE } from 'data/map/config'
import { getIsPositionSupportedInDataview } from 'features/_map/dataviews/dataviews.utils'
import {
...
import { setUserSetting } from 'features/_user/user.slice'
