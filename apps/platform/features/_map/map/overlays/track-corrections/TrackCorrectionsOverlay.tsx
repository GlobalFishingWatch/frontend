...
import { useMapViewport, useSetMapCoordinates } from 'features/_map/map/map-viewport.hooks'
...
import { usePinVessel } from 'features/_vessels/vessel/vessel-pin.hooks'
