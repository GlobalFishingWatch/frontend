...
import MapControls from 'features/_map/map/controls/MapControls'
import { selectScreenshotAreaId } from 'features/_map/map/controls/screenshot.slice'
import ErrorNotificationDialog from 'features/_map/map/overlays/error-notification/ErrorNotification'
import MapPopups from 'features/_map/map/popups/MapPopups'
...
const Hint = lazy(() => import('features/hints/Hint'))
