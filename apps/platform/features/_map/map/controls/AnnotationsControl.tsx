...
import MapControlGroup from 'features/_map/map/controls/MapControlGroup'
import {
  useMapAnnotation,
  useMapAnnotations,
} from 'features/_map/map/overlays/annotations/annotations.hooks'
...
const MapAnnotationsControls = () => {
  ...
  return (
    <MapControlGroup
      ...
      editTooltip={
        isMapAnnotating ? t((t) => t.map.annotationsStop) : t((t) => t.map.annotationsAdd)
      }
      deleteTooltip={t((t) => t.map.annotationsDelete)}
