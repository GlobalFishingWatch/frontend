...
import { selectReportAreaStatus } from 'features/_reports/report-area/area-reports.selectors'
...
const Rulers = lazy(() => import('features/_map/map/controls/RulersControl'))
const AnnotationsControl = lazy(() => import('features/_map/map/controls/AnnotationsControl'))
