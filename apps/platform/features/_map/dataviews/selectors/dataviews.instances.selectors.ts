...
import { DATASET_VERSION_SEPARATOR } from '@globalfishingwatch/datasets-client/constants'
...
import { CLUSTER_PORT_VISIT_EVENTS_DATAVIEW_SLUG } from '@platform/config/map/dataviews'
...
import { selectReportCategory, selectReportSubCategory } from 'features/_reports/reports.selectors'
...
export const selectDeprecatedDataviewInstances = createSelector(
  ...
  (dataviews) => {
    return dataviews?.filter((dataview) => dataview.deprecated)
  }
)
