...
import { selectActiveHeatmapEnvironmentalDataviewsWithoutStatic } from 'features/map/dataviews/selectors/dataviews.selectors'
import {
  selectTimebarGraph,
...
import { selectIsWorkspaceReady, selectTimeMode } from 'features/map/workspace/workspace.selectors'
