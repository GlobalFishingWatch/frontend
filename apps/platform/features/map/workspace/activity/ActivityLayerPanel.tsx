...
import { AIS_DATAVIEW_INSTANCE_ID } from 'data/map/dataviews'
import { SAR_DATAVIEW_SLUG } from 'data/map/workspaces'
...
import { TURNING_TIDES_DESCRIPTION_PREFIX } from 'features/map/bigquery/turning-tides.config'
...
import { useMigrateToLatestDataview } from 'features/map/dataviews/dataviews.hooks'
import { useActivityDataviewId } from 'features/map/map/map-layers.hooks'
import ActivityAuxiliaryLayerPanel from 'features/map/workspace/activity/ActivityAuxiliaryLayer'
import TurningTidesTags from 'features/map/workspace/activity/TurningTidesTags'
import { selectBivariateDataviews, selectReadOnly } from 'features/map/workspace/selectors/app.selectors'
import ExpandedContainer from 'features/map/workspace/shared/ExpandedContainer'
import LayerProperties from 'features/map/workspace/shared/LayerProperties'
import MapLegend from 'features/map/workspace/shared/MapLegend'
