...
import { isPrivateDataset } from 'features/map/datasets/datasets.utils'
import {
...
import DatasetNotFound from 'features/map/workspace/shared/DatasetNotFound'
import GlobalReportLink from 'features/map/workspace/shared/GlobalReportLink'
import { VisualisationChoice } from 'features/map/workspace/shared/VisualisationChoice'
    ...
    >
      {dataviews?.map((dataview, index) => {
        ...
        const showBivariateIcon =
          !bivariateDataviews && isVisible && isNextVisible && !isLastElement
