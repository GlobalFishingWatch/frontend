...
import { selectDataviewInstancesByCategory } from 'features/map/dataviews/selectors/dataviews.categories.selectors'
import {
  useLayerFilterHandlers,
  useLayerFilterState,
} from 'features/map/workspace/shared/LayerFilters.hooks'
import LayerFiltersGap from 'features/map/workspace/shared/LayerFiltersGap'
import LayerFiltersSource from 'features/map/workspace/shared/LayerFiltersSource'
import LayerSchemaFilter from 'features/map/workspace/shared/LayerSchemaFilter'
...
const HistogramRangeFilter = lazy(
  () => import('features/map/workspace/environmental/HistogramRangeFilter')
)
