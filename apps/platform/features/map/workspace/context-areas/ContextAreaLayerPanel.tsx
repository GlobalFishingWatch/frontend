...
import { useAddDataset } from 'features/map/datasets/datasets.hook'
import { getDatasetLabel, isPrivateDataset } from 'features/map/datasets/datasets.utils'
...
import ContextLayerReportLink from 'features/map/map/popups/categories/ContextLayerReportLink'
import { useContextInteractions } from 'features/map/map/popups/categories/ContextLayers.hooks'
import {
  CONTEXT_FEATURES_LIMIT,
  DATAVIEWS_WARNING,
  filterFeaturesByDistance,
  parseContextFeatures,
} from 'features/map/workspace/context-areas/context.utils'
import { selectViewport } from 'features/map/workspace/selectors/app.viewport.selectors'
import DatasetLoginRequired from 'features/map/workspace/shared/DatasetLoginRequired'
import { useLayerPanelDataviewSort } from 'features/map/workspace/shared/layer-panel-sort.hook'
import {
  POINT_PROPERTIES,
  POLYGON_PROPERTIES,
} from 'features/map/workspace/shared/layer-properties.utils'
        ...
        (DATAVIEWS_WARNING.includes(dataview?.id as any) || hasSchemaFilterSelection) && (
          ...
          >
            {DATAVIEWS_WARNING.includes(dataview?.id as any) && (
              <Fragment>
                {t((t: any) => t.dataview[dataview?.id].dataWarning)}
