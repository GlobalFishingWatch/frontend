...
import { getDataviewsSources } from 'features/map/datasets/datasets.utils'
import { selectActiveVesselsDataviews } from 'features/map/dataviews/selectors/dataviews.categories.selectors'
import { selectVesselsDataviews } from 'features/map/dataviews/selectors/dataviews.instances.selectors'
...
import LayerPanelContainer from 'features/map/workspace/shared/LayerPanelContainer'
...
import { NEW_VESSEL_GROUP_ID } from 'features/user/vessel-groups/vessel-groups.hooks'
import { selectWorkspaceVessselGroupsIds } from 'features/user/vessel-groups/vessel-groups.selectors'
import { selectVesselGroupsStatus } from 'features/user/vessel-groups/vessel-groups.slice'
import { setVesselGroupConfirmationMode } from 'features/user/vessel-groups/vessel-groups-modal.slice'
import VesselGroupAddButton from 'features/user/vessel-groups/VesselGroupAddButton'
import { isBasicSearchAllowed } from 'features/vessels/search/search.selectors'
import type { IdentityVesselData } from 'features/vessels/vessel/vessel.slice'
import { getVesselId, getVesselIdentities } from 'features/vessels/vessel/vessel.utils'
import { getVesselShipNameLabel } from 'features/vessels/vessel/vessel-label.utils'
...
import styles from 'features/map/workspace/shared/Section.module.css'
