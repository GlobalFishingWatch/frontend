...
import { selectPrivateDatasetsInWorkspace } from 'features/map/dataviews/selectors/dataviews.selectors'
...
import { saveWorkspaceThunk, setWorkspaceSuggestSave } from 'features/map/workspace/workspace.slice'
  ...
  const createWorkspace = async () => {
    ...
    if (workspaceError) {
      ...
      if (saveWorkspaceThunk.fulfilled.match(dispatchedAction)) {
        ...
        const targetType = locationType === MAP ? WORKSPACE : locationType
    ...
    >
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.row}>
          <Select
            ...
            infoTooltip={
              containsPrivateDatasets
                ? `${t((t) => t.workspace.sharePrivateDisclaimer)}: ${privateDatasets.join(', ')}`
                : ''
            }
            containerClassName={styles.select}
          ...
          {(viewAccess === WORKSPACE_PASSWORD_ACCESS ||
            ...
            <InputText
              ...
              label={t((t) => t.common.setNewPassword)}
        ...
        <div className={styles.footer}>
          ...
          >
            {t((t) => t.workspace.create) as string}
          </Button>
        </div>
      </form>
    </Modal>
