...
import { selectIsWorkspaceOwner } from 'features/map/workspace/workspace.selectors'
import type {
  UpdateCurrentWorkspaceThunkParams,
  UpdateWorkspaceThunkRejectError,
} from 'features/map/workspace/workspace.slice'
import { updateCurrentWorkspaceThunk } from 'features/map/workspace/workspace.slice'
import type {
  AppWorkspace,
  UpdateWorkspaceThunkParams,
} from 'features/map/workspaces-list/workspaces-list.slice'
import { updateWorkspaceThunk } from 'features/map/workspaces-list/workspaces-list.slice'
