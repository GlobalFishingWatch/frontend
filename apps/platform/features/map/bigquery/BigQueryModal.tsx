...
import { AggregationOptions, VisualisationOptions } from 'features/map/bigquery/bigquery.config'
import type { BigQueryVisualisation } from 'features/map/bigquery/bigquery.slice'
