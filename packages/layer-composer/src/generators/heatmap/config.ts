...
export const HEATMAP_COLOR_RAMPS: Record<ColorRampsIds, string[]> = {
  ...
  teal: ['rgba(22, 63, 137, 0)', '#004F6B', '#007B7F', '#00A793', '#00D3A7', '#00FFBC'],
  magenta: ['rgba(22, 63, 137, 0)', '#33306E', '#663D86', '#994A9E', '#994A9E', '#FF64CE'],
  lilac: ['rgba(22, 63, 137, 0)', '#1F3D78', '#3E579A', '#5E70BB', '#7D8ADD', '#9CA4FF'],
  salmon: ['rgba(22, 63, 137, 0)', '#333F64', '#665B72', '#665B72', '#CC928D', '#FFAE9B'],
  sky: ['rgba(22, 63, 137, 0)', '#004C78', '#00749A', '#009DBB', '#00C5DD', '#00EEFF'],
  red: ['rgba(22, 63, 137, 0)', '#333156', '#663E56', '#994C54', '#CC5A54', '#FF6854'],
