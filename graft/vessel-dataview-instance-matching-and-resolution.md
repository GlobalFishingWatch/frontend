---
name: Vessel Dataview Instance Matching and Resolution
slug: vessel-dataview-instance-matching-and-resolution
type: concept
sources:
...
sources_digest: 8335eac2e6580df0938e0cb84ece0e96943651d6385e75f28ada7ef3923283c5
links: []
generator:
  version: 1
covers:
...
Vessel dataview instances are selected from templates based on dataset type and optional version tolerance (matching v5.0 datasets to v4.0 templates). The matching prioritizes explicit template IDs, handles country-specific separation (Peru VMS vs. Brazil VMS), and gates the trackRealTime configuration on the presence of ssvid identifiers. Missing datasetsConfig are resolved at runtime via resolveVesselDataviewInstance by inferring related dataset IDs from vessel info.
