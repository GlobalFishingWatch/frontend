---
name: Directional Data Handling
slug: directional-data-handling
type: concept
sources:
  - path: >-
...
Special aggregation logic for circular degree data (0–360°) where averaging requires trigonometric conversion. aggregateSublayerValues mode='directionalAverage' converts degrees to radians, computes mean of sin/cos components, then converts back; prevents averaging 359° + 1° = 180° (mathematically incorrect).
