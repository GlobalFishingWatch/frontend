---
name: Coordinate Filtering & Bounds
slug: coordinate-filtering-bounds
type: concept
sources:
  - path: >-
...
Geographic clipping with world-wrapping support via longitude-wrapped feature copies. filterCellsByBounds clips cells to viewport bounds and handles antimeridian crossings where features may occupy multiple 360° world copies simultaneously. Prevents rendering out-of-bounds cells while preserving wrapped geometry.
