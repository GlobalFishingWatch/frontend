---
name: Longline Fishing Events Dataset Specialization
slug: longline-fishing-events-dataset-specialization
type: concept
sources:
...
The withLonglineSetsEvents utility augments a dataview instance by replacing its fishing events dataset with the longline-specific variant and injecting day/night category metadata into the events query. This transformation only occurs if both the longline dataset and events configuration are present, gracefully handling partial configurations.
