---
name: Range Propagation to Sublayers
slug: range-propagation-to-sublayers
type: concept
sources:
...
Value range properties (minVisibleValue, maxVisibleValue) are propagated from dataview config to individual sublayers, enabling per-sublayer heatmap filtering rather than layer-level filtering.
