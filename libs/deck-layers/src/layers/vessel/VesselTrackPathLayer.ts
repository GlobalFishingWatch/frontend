...
export type VesselTrackPathLayerProps<DataT = any> = _VesselTrackPathLayerProps<DataT> &
...
export class VesselTrackPathLayer<
  DataT = any,
  ExtraProps = Record<string, unknown>,
> extends PathLayer<DataT, VesselTrackPathLayerProps & ExtraProps> {
