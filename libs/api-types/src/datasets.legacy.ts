...
export type DatasetConfigurationUI = {
  latitude?: string
  longitude?: string
  timestamp?: string
...
export type DatasetConfiguration = DatasetBackendConfig & {
  id?: string
  index?: string
  type?: EventTypes
  source?: string
...
export type EnviromentalDatasetConfiguration = DatasetConfiguration & {
  min: number
  max: number
  offset: number
  scale: number
