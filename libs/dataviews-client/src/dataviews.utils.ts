...
export const getVesselIdFromInstanceId = (dataviewInstanceId: unknown) => {
...
export const getIsVesselDataviewInstanceId = (dataviewInstanceId: unknown) =>
  typeof dataviewInstanceId === 'string' &&
  dataviewInstanceId.startsWith(VESSEL_DATAVIEW_INSTANCE_PREFIX)

export const getIsEncounteredVesselDataviewInstanceId = (dataviewInstanceId: unknown) =>
  typeof dataviewInstanceId === 'string' &&
