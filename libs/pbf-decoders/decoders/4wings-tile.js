/*eslint-disable strict, block-scoped-var, id-length, no-control-regex, no-magic-numbers, no-prototype-builtins, no-redeclare, no-shadow, no-var, sort-vars*/
"use strict";
...
$root.tile = (function() {
    ...
    tile.Tile = (function() {
        ...
        Tile.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/tile.Tile";
        };
