...
pnpm exec nx show projects --affected --base="$NX_BASE" --head="$NX_HEAD" --type app --exclude='linting,port-labeler,*-e2e,libs/*' --plain | { grep -E '^[a-zA-Z][a-zA-Z0-9_-]*$' || true; } > affected-apps.txt
