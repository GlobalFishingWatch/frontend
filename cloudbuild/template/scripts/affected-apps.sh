...
node /opt/affected-nx/node_modules/nx/bin/nx.js show projects --affected --base="$NX_BASE" --head="$NX_HEAD" --type app --exclude='linting,port-labeler,*-e2e,libs/*' --plain > affected-apps.txt
